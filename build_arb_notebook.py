"""
Build IAQF_Arbitrage_Simulation.ipynb
Triangular arbitrage profitability simulation with REAL March 2023 transaction costs.
"""
import nbformat
...
cells.append(new_markdown_cell(
    ...
    "**Key finding:** Binance.US zero-fee promo was active all of March 2023. "
    "The binding cost for intra-exchange arb was the USDT/USD conversion (10 bps). "
    "For cross-exchange arb, Coinbase's 60 bps taker fee was the dominant friction.\n"
))
...
# ── CELL 5: FIGURE 1 — GROSS BASIS vs COST HURDLES ────────────────────────────
cells.append(new_code_cell(
    "REGIME_COLORS = {\n"
...
# ── CELL 6: FIGURE 2 — PROFITABILITY HEATMAP ──────────────────────────────────
cells.append(new_code_cell(
...
# ── CELL 7: FIGURE 3 — COST HURDLE SURVIVAL FUNCTION ─────────────────────────
cells.append(new_code_cell(
...
# ── CELL 8: FIGURE 4 — CUMULATIVE P&L ─────────────────────────────────────────
cells.append(new_code_cell(
...
# ── CELL 9: FIGURE 5 — CRISIS WINDOW DEEP DIVE ────────────────────────────────
cells.append(new_code_cell(
...
cells.append(new_markdown_cell(
    ...
    "The most striking finding is that **Binance.US was offering zero trading fees on all BTC pairs** "
    "throughout the entire March 2023 period (a promotion active June 2022 – January 2024). "
    "The dominant cost for a Binance.US-only arbitrageur was therefore the **USDT/USD conversion "
    "fee (10 bps)** and market impact from slippage — not the trading fee itself.\n\n"
    "For **cross-exchange arbitrage**, the Coinbase Advanced Trade taker fee of **60 bps** was the "
    "binding constraint. At this level, the arbitrage was only profitable during the crisis window "
    "when the gross basis exceeded 71 bps — which it did spectacularly, reaching over **1,300 bps** "
    "at the peak on March 11.\n\n"
    ...
    "The March 2023 crisis created arbitrage opportunities precisely because the USDC/USD peg broke — "
    "the credit risk premium embedded in the stablecoin's price diverged from its theoretical $1 value. "
    "Under the GENIUS Act's 100% reserve backing with T-bills and monthly public disclosures, this type "
    "of credit-risk-driven de-peg would be far less likely to occur. The regulation would effectively "
    "**eliminate the largest component of the arbitrage opportunity** — the stablecoin FX component — "
    "leaving only the residual basis driven by pure market frictions (latency, fees, order flow imbalances).\n\n"
...
out_path = '/home/ubuntu/IAQF_2026/notebooks/IAQF_Arbitrage_Simulation.ipynb'
...
if errors:
    ...
    print(f"All {code_cells} code cells pass syntax check. Ready to execute.")
